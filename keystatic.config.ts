...
const eyebrowFields = {
  ...
  eyebrowLarge: fields.checkbox({ label: 'Large eyebrow', defaultValue: false }),
};
  ...
  fields.conditional(
    sectionDiscriminant,
    {
      ...
      hero: fields.object({
        ...
        backgroundPosition: fields.text({ label: 'Background position', defaultValue: '58% 55%' }),
        eyebrow: fields.text({ label: 'Eyebrow label', defaultValue: 'Mandrex VA Services' }),
        headline: fields.text({ label: 'Headline' }),
        lead: fields.text({ label: 'Lead paragraph' }),
        primaryButton: fields.object(buttonFields, { label: 'Primary button' }),
        secondaryButton: fields.object(buttonFields, { label: 'Secondary button' }),
        stats: fields.array(
          fields.object({
            value: fields.text({ label: 'Value' }),
            label: fields.text({ label: 'Label' }),
            accent: fields.checkbox({ label: 'Accent style', defaultValue: false }),
          }),
      ...
      innerHero: fields.object({
        ...sectionBase,
        backgroundImage: imageField('Background image'),
        backgroundPosition: fields.text({ label: 'Background position', defaultValue: '50% 45%' }),
        eyebrow: fields.text({ label: 'Eyebrow label' }),
        headline: fields.text({ label: 'Headline' }),
        lead: fields.text({ label: 'Lead paragraph' }),
      ...
      serviceGrid: fields.object({
        ...sectionBase,
        eyebrow: fields.text({ label: 'Eyebrow label', defaultValue: 'What we do' }),
      ...
      whyChooseUs: fields.object({
        ...sectionBase,
        backgroundImage: imageField('Background image'),
        eyebrow: fields.text({ label: 'Eyebrow label', defaultValue: 'Why choose us' }),
        title: fields.text({ label: 'Title' }),
      ...
      industriesGrid: fields.object({
        ...sectionBase,
        eyebrow: fields.text({ label: 'Eyebrow label', defaultValue: 'Industries' }),
        title: fields.text({ label: 'Title' }),
        description: fields.text({ label: 'Description' }),
        ctaTitle: fields.text({ label: 'CTA tile title', defaultValue: 'Not listed?' }),
        ctaDescription: fields.text({ label: 'CTA tile description', defaultValue: 'Tell us what your operations need →' }),
        ctaHref: fields.text({ label: 'CTA tile link', defaultValue: '/contact' }),
      }),
      globalReach: fields.object({
        ...sectionBase,
        mainImage: imageField('Main image'),
        insetImage: imageField('Inset image'),
        eyebrow: fields.text({ label: 'Eyebrow label', defaultValue: 'Global reach' }),
        title: fields.text({ label: 'Title' }),
        description: fields.text({ label: 'Description' }),
        stats: fields.array(
          fields.object({
      ...
      founder: fields.object({
        ...
        photoPosition: fields.text({ label: 'Photo object position', defaultValue: 'center 20%' }),
        name: fields.text({ label: 'Founder name' }),
        role: fields.text({ label: 'Founder role' }),
        eyebrow: fields.text({ label: 'Eyebrow label', defaultValue: "Founder's note" }),
        title: fields.text({ label: 'Title' }),
      ...
      serviceCards: fields.object({
        ...
        descriptionOverrides: fields.array(
          ...
          { label: 'Description overrides', itemLabel: (props) => props.fields.service.value || 'Override' }
        ),
      }),
      ...
      testimonialsGrid: fields.object({
        ...sectionBase,
        ctaTitle: fields.text({ label: 'CTA title', defaultValue: 'Your story next' }),
      ...
      contactSection: fields.object({
        ...sectionBase,
        title: fields.text({ label: 'Details title', defaultValue: 'Contact details' }),
        formTitle: fields.text({ label: 'Form title', defaultValue: 'Send us a message' }),
        formSuccessTitle: fields.text({ label: 'Success title', defaultValue: 'Message received' }),
      ...
      notFound: fields.object({
        ...
        backgroundImage: imageField('Background image'),
        backgroundPosition: fields.text({ label: 'Background position', defaultValue: '58% 55%' }),
        eyebrow: fields.text({ label: 'Eyebrow label', defaultValue: 'Error 404' }),
        title: fields.text({ label: 'Title' }),
        lead: fields.text({ label: 'Lead paragraph' }),
        primaryButton: fields.object(buttonFields, { label: 'Primary button' }),
        secondaryButton: fields.object(buttonFields, { label: 'Secondary button' }),
  ...
  collections: {
    pages: collection({
      ...
      schema: {
        ...
        description: fields.text({ label: 'Meta description', validation: { isRequired: true } }),
    ...
    reusableSections: collection({
      ...
      slugField: 'name',
      schema: {
        name: fields.text({ label: 'Section name', validation: { isRequired: true } }),
    ...
    services: collection({
      ...
      schema: {
        ...
        heroObjectPosition: fields.text({ label: 'Hero object position', defaultValue: '50% 50%' }),
        ...
        topBarColor: fields.text({ label: 'Top bar color', defaultValue: '#306A42' }),
        ...
        scope: fields.array(
          ...
          { label: 'Scope items', itemLabel: (props) => props.fields.title.value }
        ),
    ...
    testimonials: collection({
      ...
      slugField: 'slug',
      schema: {
        service: fields.text({ label: 'Service', validation: { isRequired: true } }),
        slug: fields.text({ label: 'Slug', validation: { isRequired: true } }),
    ...
    industries: collection({
      ...
      schema: {
        ...
        icon: fields.text({ label: 'Icon name', validation: { isRequired: true } }),
      },
    }),
  },
  singletons: {
      ...
      schema: {
        nav: fields.object({
          pages: fields.array(
            ...
            { label: 'Nav pages', itemLabel: (props) => props.fields.label.value }
          ),
          cta: fields.object(
            {
              label: fields.text({ label: 'Label' }),
        ...
        footer: fields.object({
          ...
          pages: fields.array(
            ...
            { label: 'Footer pages', itemLabel: (props) => props.fields.label.value }
          ),
